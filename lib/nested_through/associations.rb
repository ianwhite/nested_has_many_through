module NestedThrough
  ...
  module Associations
    def has_many(association_id, options = {}, &extension)
      reflection = (create_has_many_reflection(association_id, options, &extension) rescue nil)
      if reflection && (reflection.nested_through? || reflection.source_through?)
    ...
    def has_one(association_id, options = {})
      reflection = (create_has_one_through_reflection(association_id, options) rescue nil)
      if reflection && (reflection.nested_through? || reflection.source_through?)
